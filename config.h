...
/* commands */
static const char *launchercmd[] = { "rofi", "-show", "drun", "-theme", "~/.config/rofi/launchers/type-3/style-2.rasi", NULL };
static const char *switchercmd[] = { "rofi", "-show", "window", "-theme", "~/.config/rofi/switcher.rasi", NULL };
static const char *powercmd[] 	 = { "/bin/sh", "-c", "~/.config/rofi/scripts/powermenu_t2", NULL };
...
static Key keys[] = {
    ...
    { 0,                            XF86XK_MonBrightnessUp,    spawn,          SHCMD ("brightnessctl set 7%-")},
    { 0,                            XF86XK_MonBrightnessDown,  spawn,          SHCMD ("brightnessctl set 7%+")},
